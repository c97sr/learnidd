...
**Q 1.1** Copy the chart and describe it. Use [https://www.streetmap.co.uk](www.streetmap.co.uk) to see if you can match the (slightly fuzzy) shape to the coastline of Kent. On street map, the default coordinates at the bottom of the map window are in OS grid references.
